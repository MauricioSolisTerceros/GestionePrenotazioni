...
import it.mauriciosolis.gestioneprenotazioni.service.EdificioService;
...
//		if(edificio.getPasswordEdificio().length()<=8) {
		this.edificioService.saveEdificio(edificio);
		return "E' stato aggiunto un edifico";
		}
//		else 
