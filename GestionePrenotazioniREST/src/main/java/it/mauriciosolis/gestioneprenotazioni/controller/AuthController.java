package it.mauriciosolis.gestioneprenotazioni.controller;
...
import it.mauriciosolis.gestioneprenotazioni.request.LoginRequest;
import it.mauriciosolis.gestioneprenotazioni.request.SignupRequest;
import it.mauriciosolis.gestioneprenotazioni.response.LoginResponse;
import it.mauriciosolis.gestioneprenotazioni.response.SignupResponse;
import it.mauriciosolis.gestioneprenotazioni.security.JwtUtils;
import it.mauriciosolis.gestioneprenotazioni.security.UserDetailsImpl;
...
public class AuthController {
	...
	@PostMapping("/login2")
	public ResponseEntity<?> authenticateUser2(@RequestParam String username, String password) {
		// Usa l'AuthenticationManager per autenticare i parametri della request
